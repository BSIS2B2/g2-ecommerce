...
.nav-links { flex-grow: 1; text-align: center; }  /* Center align */
...
def product_card(name, price, category="Bags", color="Black", feature="Durable", description="High-quality product"):
    ...
    with st.container():
        ...
        if st.button("Add to Cart", key=add_to_cart_key):
            ...
            # Success message without clearing page
            st.toast(f"{name} added to cart and Ticket #{ticket_id} created!")  # Streamlit 1.24+ supports st.toast

# --- Header ---
def render_header():
    # Layout: logo | nav links | cart
    col1, col2, col3 = st.columns([2,6,2])  # Adjust proportion for centering

    with col1:
        st.markdown("<div class='logo'>δ SwiftBuy</div>", unsafe_allow_html=True)

    with col2:
        # Center nav buttons using columns inside col2
...
product_list = [
    ...
    {"name":"Leather Office Bag", "price":450, "category":"Bags", "color":"Brown", "feature":"Durable", "description":"Professional look for office use."},
    {"name":"Mini Sling Bag", "price":180, "category":"Bags", "color":"Black", "feature":"Ergonomic", "description":"Lightweight sling bag for daily essentials."},
    {"name":"School Backpack", "price":220, "category":"Bags", "color":"Red", "feature":"Durable", "description":"Perfect for students and school needs."},
    ...
    {"name":"Grid Notebook", "price":20, "category":"Notebooks", "color":"White", "feature":"Durable", "description":"Ideal for math and technical notes."},
    {"name":"Journal Notebook", "price":35, "category":"Notebooks", "color":"Brown", "feature":"Durable", "description":"Personal journal with premium paper."},
    {"name":"Study Notes Pad", "price":18, "category":"Notebooks", "color":"Blue", "feature":"Ergonomic", "description":"Designed for long study sessions."},
    ...
    {"name":"Color Pencil Pack", "price":25, "category":"Pencils", "color":"Multi", "feature":"Durable", "description":"Bright colors for art and design."},
    {"name":"Mechanical Pencil", "price":10, "category":"Pencils", "color":"Grey", "feature":"Ergonomic", "description":"Refillable and easy to use."},
    {"name":"Kids Pencil Set", "price":12, "category":"Pencils", "color":"Yellow", "feature":"Durable", "description":"Safe and fun pencils for kids."},
    ...
    {"name":"Phone Stand", "price":15, "category":"Accessories", "color":"Black", "feature":"Ergonomic", "description":"Hands-free phone holder."},
    {"name":"USB Cable Organizer", "price":12, "category":"Accessories", "color":"White", "feature":"Durable", "description":"Neatly organize your cables."},
    ...
    {"name":"Bluetooth Speaker", "price":120, "category":"Electronics", "color":"Black", "feature":"Waterproof", "description":"Portable speaker with powerful bass."},
    {"name":"Wireless Mouse", "price":40, "category":"Electronics", "color":"Grey", "feature":"Ergonomic", "description":"Smooth and precise mouse."},
    {"name":"Keyboard Combo", "price":90, "category":"Electronics", "color":"Black", "feature":"Durable", "description":"Keyboard and mouse combo."},
    {"name":"Power Bank", "price":60, "category":"Electronics", "color":"Blue", "feature":"Durable", "description":"Fast charging power bank."},
    {"name":"Smart Watch", "price":150, "category":"Electronics", "color":"Black", "feature":"Waterproof", "description":"Track fitness and notifications."},
]
